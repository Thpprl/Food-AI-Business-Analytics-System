...
เงื่อนไขสำคัญ:
- ข้อมูลที่เป็นค่า (Value) ใน JSON ทุกช่อง "ต้องเป็นภาษาไทย 100% เท่านั้น"
- ห้ามใช้คำศัพท์ภาษาอังกฤษในเนื้อหา (ยกเว้นชื่อเฉพาะของธุรกิจ)
- หากมีคำศัพท์เทคนิค ให้ใช้คำทับศัพท์ภาษาไทยที่คนไทยเข้าใจง่าย
...
- ทุก field ต้องมีข้อมูลอย่างน้อย 4 รายการ
